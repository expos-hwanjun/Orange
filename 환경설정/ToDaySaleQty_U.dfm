object ToDaySaleQty_F: TToDaySaleQty_F
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'ToDaySaleQty_F'
  ClientHeight = 768
  ClientWidth = 1024
  Color = clBtnFace
  ...
  object TitleLabel: TLabel
    ...
    HelpKeyword = 'C'
    AutoSize = False
    Caption = #45817#51068' '#54032#47588#49688#47049' '#49444#51221
    Font.Charset = HANGEUL_CHARSET
    Font.Color = clWhite
    Font.Height = -31
    Font.Name = #47569#51008' '#44256#46357
  ...
  object Grid: TcxGrid
    ...
    object gvMaster1: TcxGridTableView
      ...
      object gvMaster1Column1: TcxGridColumn
        Caption = 'NO'
      ...
      object gvMaster1Column2: TcxGridColumn
      ...
      object gvMaster1Column3: TcxGridColumn
      ...
      object gvMaster1Column4: TcxGridColumn
      ...
      object gvMaster1Column5: TcxGridColumn
      ...
      object gvMaster1Column6: TcxGridColumn
        Caption = #44396#48516
        PropertiesClassName = 'TcxLabelProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
      ...
      object gvMaster1Column7: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column8: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column9: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column10: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column11: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column12: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column13: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column14: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column15: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column16: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column17: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#0'
        Visible = False
      end
      object gvMaster1Column18: TcxGridColumn
        Visible = False
      end
      object gvMaster1Column19: TcxGridColumn
        Visible = False
      end
      object gvMaster1Column20: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Visible = False
      end
      object gvMaster1Column21: TcxGridColumn
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Visible = False
      end
      object gvMaster1Column22: TcxGridColumn
        Visible = False
      end
    end
    object GridTableView: TcxGridTableView
      ...
      object GridTableViewSetQty: TcxGridColumn
        Caption = #49444#51221#49688#47049
        ...
        Properties.OnValidate = GridTableViewSetQtyPropertiesValidate
        HeaderAlignmentHorz = taCenter
        Options.Filtering = False
        Options.Grouping = False
        Options.Moving = False
        Styles.Content = StyleFontBold
        Styles.OnGetContentStyle = GridTableViewSetQtyStylesGetContentStyle
        Styles.Header = StyleHeader
        Width = 80
      end
      ...
      object GridTableViewisDefault: TcxGridColumn
  ...
  object GridEndButton: TAdvGlassButton
    Left = 703
    Top = 590
    Width = 37
    Height = 119
    BackColor = 5844224
    BackGroundSymbol = bsCustom
  ...
  object GridFirstButton: TAdvGlassButton
    Left = 703
    Top = 470
    Width = 37
    Height = 119
