...
type
  TKioskCashReceipt_F = class(TForm)
...
var
  KioskCashReceipt_F: TKioskCashReceipt_F;
...
procedure TKioskCashReceipt_F.Num1ButtonClick(Sender: TObject);
begin
...
function TKioskCashReceipt_F.GetPhoneFormat(vStr: String): String;
var vTemp :String;
begin
...
procedure TKioskCashReceipt_F.FormCreate(Sender: TObject);
begin
...
procedure TKioskCashReceipt_F.OkButtonClick(Sender: TObject);
begin
  try
    BlockInput(true);
...
procedure TKioskCashReceipt_F.obtn_cardClick(Sender: TObject);
begin
  Common.KioskTouchBeep('kioskwave12');
...
procedure TKioskCashReceipt_F.AgreeLabelClick(Sender: TObject);
begin
  if AgreeButton.Tag = 0 then
  begin
    AgreeButton.Tag := 1;
...
function TKioskCashReceipt_F.ApprovalAction: Boolean;
begin
  BlockInput(true);
  try
    Result := false;
...
procedure TKioskCashReceipt_F.BSButtonClick(Sender: TObject);
begin
  Common.KioskTouchBeep('kioskwave11');
...
procedure TKioskCashReceipt_F.CancelButtonClick(Sender: TObject);
begin
...
procedure TKioskCashReceipt_F.ClearButtonClick(Sender: TObject);
begin
  Common.KioskTouchBeep('kioskwave11');
  KeyInLabel.Hint    := '010';
...
procedure TKioskCashReceipt_F.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Common.isCashRecieptCard := false;
end;

procedure TKioskCashReceipt_F.FormShow(Sender: TObject);
begin
